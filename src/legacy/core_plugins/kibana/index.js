      ...
      links: [
        {
          ...
          icon: 'plugins/kibana/assets/discover.png',
          ...
          icon: 'plugins/kibana/assets/visualize.png',
          ...
          icon: 'plugins/kibana/assets/dashboard.png',
          ...
          icon: 'plugins/kibana/assets/devTools.png',
          ...
          icon: 'plugins/kibana/assets/management.png',
