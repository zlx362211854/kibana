...
import EuiSuperUpdateButton from './superUpdateButton.js';
import {
  ...
  EuiFlexGroup,
  EuiFlexItem,
  commonlyUsedRangeShape, recentlyUsedRangeShape,
  prettyDuration, showPrettyDuration,
  prettyInterval
} from '@elastic/eui';
...
export default class EuiSuperDatePicker extends Component {
