...
class UiSettingsService {
    start({ notifications, loadingCount, injectedMetadata, basePath }) {
        this.uiSettingsApi = new ui_settings_api_1.UiSettingsApi(basePath, injectedMetadata.getKibanaVersion());
        ...
        this.uiSettingsClient = new ui_settings_client_1.UiSettingsClient({
            ...
            onUpdateError: error => {
                notifications.toasts.addDanger({
                    title: i18n_1.i18n.translate('core.uiSettings.unableUpdateUISettingNotificationMessageTitle', {
